...
@section('content')
    ...
    <div class="card">
        ...
        <div class="card-body">
            <a class="btn btn-primary-gradient py-2 mx-2 px-4 d-md-inline-block d-block mb-4" id="btn-new-peserta">Tambah Peserta</a>
            <a class="btn btn-outline-danger py-2 px-4 mx-2 d-md-inline-block d-block mb-4" id="deleteall">Delete Selected</a>
    ...
    "<'dt--bottom-section d-sm-flex justify-content-sm-between text-center mt-3'<'dt--pages-count mb-sm-0 mb-3'i><'dt--pagination'p>>",  
        ...
        "pageLength": 10,
            ...
            $.get('/peserta/'+id+'/edit', function (data) {
                $('#pesertaModalLabel').html("Edit User");
            ...
            $(document).on('click', '#delete-peserta', function () {
                    ...
                    Swal.fire({
                        title: 'Are you sure ?',
                        text: "This peserta data will be permanently delete",
                        icon: 'warning',
                 ...
                 $(function(){
                    ...
                    $('#deleteall').on('click', function(e){
                        ...
                        if(ids.length <= 0)
                        {
                            ...
                            text: "Peserta data will be permanently delete",
                            icon: 'warning',
                            showCancelButton: true,
                            confirmButtonColor: '#47C363',
                            cancelButtonColor: '#d33',
