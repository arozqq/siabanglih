        ...
        <div class="container-xxl py-5" id="kandidat">
            <div class="container py-5 px-lg-5">
                <div class="row g-5 align-items-center">
                        ...
                        <div class="row g-4 mb-4">
                            ...
                            <div class="col-sm-4 wow fadeIn" data-wow-delay="0.7s">
                                <div class="d-flex">
                                    ...
                                    <div class="ms-3">
                                        <h2 class="mb-0" data-toggle="counter-up">1234</h2>
                                        <p class="text-secondary-gradient mb-0">Peserta Belum Memilih</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="col-lg-6">
                        <img class="img-fluid wow fadeInUp" data-wow-delay="0.5s" src="{{asset('asset/img/about.png')}}">
                    </div>
                </div>
            </div>
        </div>
